                    ...
                    <div class="row">
                            ...
                            <div class="card card-plain mt-8">
                                ...
                                <div class="card-body">
                                    <form role="form" id="login_user">
                                        <label>Usuario</label>
                                        <div class="mb-3">
                                            <input type="text" class="form-control" name="usuario" id="usuario" placeholder="Usuario" aria-label="Usuario" aria-describedby="usuario-addon">
                                        </div>
                                        <label>Contraseña</label>
                                        <div class="mb-3">
                                            <input type="text" class="form-control" name="clave" id="clave" placeholder="Contraseña" aria-label="Contraseña" aria-describedby="contraseña-addon">
                                        </div>
                                ...
                                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                    <p class="mb-4 text-sm mx-auto">
                                        Deseas contratar un bot?
                                        <a href="javascript:;" class="text-info text-gradient font-weight-bold">Solicitalo</a>
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image:url('assets/img/login img.svg')"></div>
                            </div>
                        </div>
                    </div>
                </div>
